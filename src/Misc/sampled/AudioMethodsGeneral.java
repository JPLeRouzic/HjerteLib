...
public class AudioMethodsGeneral
{
        ...
        AudioMethodsGeneral goglAMG = new AudioMethodsGeneral() ;
        AudioMethodsDSP goglAMDSP = new AudioMethodsDSP() ;

    public AudioMethodsGeneral()
    {
    }

    public AudioFormat getCopyOfAudioFormat(AudioFormat old_audio_format)
    {
    ...
    public String getAudioFormatData(AudioFormat audio_format)
    {
    ...
    public String getAudioFileFormatData(File file)
        throws Exception
    {
        try {
        String data;
    ...
    public String[] getAvailableFileFormatTypes()
    {
    ...
    public javax.sound.sampled.AudioFileFormat.Type getAudioFileFormatType(String file_type_name)
    {
    ...
    public String getAvailableMixerData()
    {
    ...
    public Mixer getMixer(int mixer_index, AudioEventLineListener listener)
    {
        javax.sound.sampled.Mixer.Info mixer_info[] = AudioSystem.getMixerInfo();
    ...
    public TargetDataLine getTargetDataLine(AudioFormat audio_format, AudioEventLineListener listener)
        throws Exception
    {
        final DataLine.Info data_line_info = new DataLine.Info(TargetDataLine.class, audio_format);
    ...
    public TargetDataLine getTargetDataLine(AudioFormat audio_format, Mixer mixer, AudioEventLineListener listener)
        throws Exception
    {
        final DataLine.Info data_line_info = new DataLine.Info(TargetDataLine.class, audio_format);
        TargetDataLine target_data_line = null;
    ...
    public SourceDataLine getSourceDataLine(AudioFormat audio_format, AudioEventLineListener listener)
    {
    ...
    public AudioInputStream getInputStream(ByteArrayOutputStream byte_stream, AudioFormat audio_format)
    {
    ...
    public AudioInputStream getInputStream(byte audio_bytes[], AudioFormat audio_format)
    {
        java.io.InputStream input_byte_stream = new ByteArrayInputStream(audio_bytes);
        long number_of_sample_frames = audio_bytes.length / audio_format.getFrameSize();
        AudioInputStream audio_input_stream = new AudioInputStream(input_byte_stream, audio_format, number_of_sample_frames);
    ...
    public AudioInputStream getInputStream(File audio_file)
        throws Exception
    {
    ...
    public AudioFormat getConvertedAudioFormat(AudioFormat original_format)
    {
    ...
    public AudioInputStream getConvertedAudioStream(AudioInputStream audio_input_stream)
    {
    ...
    public AudioInputStream convertUnsupportedFormat(AudioInputStream audio_input_stream)
    {
    ...
    public float[][] extractSampleValues(AudioInputStream audio_input_stream)
        throws Exception
    {
        ...
        float max_sample_value = goglAMDSP.findMaximumSampleValue(bit_depth) + 2.0F;
    ...
    public byte[] getBytesFromAudioInputStream(AudioInputStream audio_input_stream)
        throws Exception
    {
    ...
    public int getNumberBytesNeeded(float duration_in_seconds, AudioFormat audio_format)
    {
    ...
    public int getNumberBytesNeeded(int number_samples, AudioFormat audio_format)
    {
    ...
    public AudioInputStream convertToAudioInputStream(float samples[][], AudioFormat audio_format)
        throws Exception
    {
    ...
    public void writeSamplesToBuffer(float sample_values[][], int bit_depth, byte buffer[])
        throws Exception
    {
        ...
        sample_values = goglAMDSP.clipSamples(sample_values);
        float max_sample_value = goglAMDSP.findMaximumSampleValue(bit_depth);
    ...
    public void saveByteArrayOutputStream(ByteArrayOutputStream audio, AudioFormat audio_format, File save_file, javax.sound.sampled.AudioFileFormat.Type file_type)
        throws Exception
    {
        if(audio == null)
    ...
    public void saveToFile(AudioInputStream audio_input_stream, File file_to_save_to, javax.sound.sampled.AudioFileFormat.Type file_type)
        throws Exception
    {
