...
public class StatsMaths
{
    ...
    public float[] getDiff(float data[])
        throws Exception
    {
    ...
    public float[][] reshape(float A[][], int m, int n)
    {
        int origM = A.length;
    ...
    public float getStandardDeviation(int data[])
    {
        if(data.length < 2)
            return 0.0F;
        float average = getAverage(data);
    ...
    public boolean isFactorOrMultiple(int x, int y, int z[])
    {
    ...
    public int getIndexOfSmallest(float values[])
    {
        int min_index = 0;
    ...
    public int getIndexOfLargest(float values[])
    {
        int max_index = 0;
        for(int i = 0; i < values.length; i++)
    ...
    public int getIndexOfLargest(int values[])
    {
        int max_index = 0;
        for(int i = 0; i < values.length; i++)
            if(values[i] > values[max_index])
    ...
    public float calculateEuclideanDistance(float x[], float y[])
        throws Exception
    {
    ...
    public int[] getRandomOrdering(int number_entries)
    {
    ...
    public float getArraySum(float to_sum[])
    {
        float sum = 0.0F;
    ...
    public float[] normalize(float to_normalize[])
    {
    ...
    public float logBaseN(float x, float n)
    {
